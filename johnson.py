...
from utils import get_filled_matrix, transponse, get_sorted_matrix, get_plot_ranges , get_plot_ranges_with_value
import numpy as np
...
if __name__ == "__main__":
    ...
    plot_ranges = get_plot_ranges_with_value(tasks_matrix)
